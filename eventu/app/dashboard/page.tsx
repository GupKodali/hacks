...
//   // --- NEW: compute "happening now" events ---
...
//   // --- NEW: Quick Join bypasses overlap rule (by design) ---
//   function handleQuickJoin(ev: EventItem) {
//     setWarning(null)
...
//     if (conflicts) {
//       setWarning("Quick Join added an event that overlaps your schedule (allowed for Jump In Right Now).")
//     }
...
//               <div>
//                 <h2 className="text-lg font-medium">Jump in Right Now</h2>
//                 <p className="text-sm text-muted-foreground">
//                   Events currently happening. This can ignore your usual schedule preferences.
//                 </p>
//               </div>
//               <div className="text-sm text-muted-foreground">
...
//                 {happeningNowEvents.map((ev) => {
//                   const already = registrations.some((r) => r.event.id === ev.id)
//                   const conflicts = registeredEvents.some((reg) => overlaps(reg, ev))

//                   return (
//                     <Card key={ev.id} className="border-indigo-200">
//                       <CardHeader>
//                         <CardTitle className="flex items-center justify-between gap-2">
//                           <span>{ev.title}</span>
//                           <span className="text-xs rounded-full px-2 py-1 bg-indigo-100">
//                             Live
//                           </span>
//                         </CardTitle>
...
export default function DashboardPage() {
  ...
  // ✅ keep time fresh so the popup updates if it’s open near 1PM
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={jumpOpen} onOpenChange={setJumpOpen}>
              <DialogTrigger asChild>
                <Button disabled={!user || isLoading} variant="default">
                  Jump In Right Now
                </Button>
              </DialogTrigger>
